...
exports.formatDateFromString = exports.compareDataParse = exports.dateList = void 0;
/**
 ...
 */
const compareDataParse = (unit, format, options) => {
    ...
    return `${unitParsed} ${aliases.at(-1)}`;
};
exports.compareDataParse = compareDataParse;
/**
